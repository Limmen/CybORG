...
from cyborg.shared.actions.green_actions.green_ping_sweep import GreenPingSweep
from cyborg.shared.actions.green_actions.green_port_scan import GreenPortScan
